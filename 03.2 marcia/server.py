...
def muoviMotori(mov):
    ...
    if mov == 'q':  # Avanti + Sinistra
        robot.setMotor(-(80*marcia), (30*marcia))  # Sinistro più lento, destro più veloce
    elif mov == 'e':  # Avanti + Destra
        robot.setMotor(-(50*marcia), (80*marcia))  # Sinistro più veloce, destro più lento
    elif mov == 'z':  # Indietro + Sinistra
        robot.setMotor((80*marcia), -(30*marcia))  # Sinistro indietro più lento, destro più veloce
    elif mov == 'x':  # Indietro + Destra
        robot.setMotor((50*marcia), -(80*marcia))  # Sinistro indietro più veloce, destro più lento
    elif mov == 'w':  # Solo Avanti
        # Prova a ridurre leggermente la potenza del motore destro
        robot.setMotor(-(50*marcia), (48*marcia))
    elif mov == 's':  # Solo Indietro
        robot.setMotor((50*marcia), -(50*marcia))
    elif mov == 'a':  # Solo Sinistra
        robot.setMotor(-(50*marcia), 0)
    elif mov == 'd':  # Solo Destra
        robot.setMotor(0, (50*marcia))
